    ...
    <>
      ...
      <div className="row justify-content-center w-100 m-0">
        <div className="col-sm-12 col-md-6 alert alert-warning p-3 m-0">
          ...
          <p>
            Buckle up, select your gear and accelerate! Virtual Racing Car is
            one of the popular video attractions,when you feel the chaos, noise,
            and excitement, you will see why. With hand on the wheel, foot on
            the brake and eyes locked into a screen, you will feel completely
            immersed in the world of racing as you race your friends to the
            finish line. Racing enthusiasts show off your driving skills and
            prepare for an unparalleled and unprecedented experience which will
            closely replicate on track racing.
          </p>
        </div>
        <div className="col-sm-12 col-md-6 img-div">
          <img
            src="assests/images/Virtual Racing Cars.jpg"
            className="img-fluid"
            alt="..."
          />
        </div>
